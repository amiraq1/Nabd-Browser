...
export const AudioReaderSheet = forwardRef<BottomSheet, AudioReaderSheetProps>(
    function AudioReaderSheet({ onClose }, ref) {
        ...
        const speak = async () => {
            ...
            // Start new speech
            const textToRead = pageContent || "لا يوجد محتوى قابل للقراءة في هذه الصفحة.";
            ...
            >
                <BottomSheetView style={[styles.content, { paddingBottom: insets.bottom + Spacing.lg }]}>
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={{ flex: 1 }}>
                            <ThemedText type="body" style={{ fontWeight: '600' }}>القارئ الصوتي</ThemedText>
                    ...
                    <View style={[styles.statusContainer, { backgroundColor: colors.backgroundSecondary }]}>
                            ...
                            {[1, 2, 3, 4, 5].map((i) => (
                                <View
                                    ...
                                    style={[
                                        styles.bar,
                                        {
                                            backgroundColor: isPlaying ? colors.accent : colors.border,
                        ...
                        <ThemedText style={{ marginTop: 12, opacity: 0.8 }}>{statusText}</ThemedText>
                    </View>
                    ...
                    <View style={styles.controls}>
                        ...
                        <Pressable style={styles.controlBtnSmall} onPress={toggleRate}>
                            <ThemedText style={{ fontWeight: 'bold', color: colors.text }}>{rate}x</ThemedText>
                        </Pressable>
